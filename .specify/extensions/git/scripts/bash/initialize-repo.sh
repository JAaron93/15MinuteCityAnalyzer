...
if [ -f "$_config_file" ]; then
    # Note: This is an ad-hoc YAML parser. It only supports simple single-line
    # "key: value" pairs and cannot handle multiline strings, anchors, folded blocks,
    # or nested structures. For complex configs, use a proper YAML parser like yq.
